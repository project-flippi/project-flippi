...
def run_schedule():
    ...
    schedule.every().tuesday.at("18:00").do(process_and_upload_comp)
    schedule.every().wednesday.at("11:00").do(process_and_upload_short)
    schedule.every().wednesday.at("18:00").do(process_and_upload_short)
    schedule.every().thursday.at("11:00").do(process_and_upload_short)
    schedule.every().thursday.at("18:00").do(process_and_upload_short)
    schedule.every().friday.at("11:00").do(process_and_upload_short)
    schedule.every().friday.at("18:00").do(process_and_upload_short)
    schedule.every().saturday.at("11:00").do(process_and_upload_short)
    schedule.every().saturday.at("18:00").do(process_and_upload_short)
    schedule.every().sunday.at("11:00").do(process_and_upload_short)
    schedule.every().sunday.at("18:00").do(process_and_upload_short)
