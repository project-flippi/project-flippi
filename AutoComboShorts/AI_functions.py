...
def provide_comp_thumbnail(title):
    ...
    try:
        response = client.images.generate(
            ...
            output_format='png', #Must be one of png, jpeg, or webp
...
def provide_image(title):
    ...
    prompt = (
        f"Design a bright and colorful thumbnail for a compilation of clips from the event {additional_prompt}. "
...
#provide_image("Smash Bros Melee Madness: Fox and DK's Epic Showdown!")
#Need to add a retry function for image creation, max of 3 times before passing
